<%@ Page Title="Historial de visitas" Language="C#" AutoEventWireup="true" CodeBehind="WFListadoVisitasC.aspx.cs" Inherits="WSProyectos.Consejeria.WFListadoVisitasC" MasterPageFile="~/Site.Master"%>
                    ...
                    <td colspan="3">
                        <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False" AllowPaging="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="EstadoVisita" HeaderText="EstadoVisita" SortExpression="EstadoVisita">

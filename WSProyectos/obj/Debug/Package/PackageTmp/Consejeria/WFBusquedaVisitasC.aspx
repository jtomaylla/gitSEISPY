<%@ Page Title="Búsqueda de visitas" Language="C#" AutoEventWireup="true" CodeBehind="WFBusquedaVisitasC.aspx.cs" Inherits="WSProyectos.Consejeria.WFBusquedaVisitasC" MasterPageFile="~/Site.Master"%>
                        ...
                        <table width="800px">
                           <tr>
                            <td><asp:Label ID="Label1" runat="server" CssClass="Titulitos" 
                                    Text="Registrar Datos - Búsqueda de Visitas"></asp:Label></td>
                        </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:GridView ID="gvListado" runat="server" AllowPaging="True" 
                                        ...
                                        <Columns>
                                            ...
                                            <HeaderStyle CssClass="header2" /><ItemStyle CssClass="Item2" Width="100px" /> </asp:BoundField>
                                            <asp:TemplateField HeaderText="Id_TAM"  ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hypTAM"  runat="server" ToolTip="" Text='<%# Eval("Id_TAM") %>' navigateurl='<%# String.Format("WFAsignarTAM.aspx?CodigoPaciente={0}&CodigoLocal={1}&CodigoProyecto={2}&CodigoUsuario={3}", Eval("CodigoPaciente"), Eval("CodigoLocal"), Eval("CodigoProyecto"),numUsuario) %>'> 
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="Header2" HorizontalAlign="Center" /><ItemStyle CssClass="Item2"/>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Id_ENR"  ShowHeader="False">
                                                <ItemTemplate>
                                                    <asp:HyperLink ID="hypENR"  runat="server" ToolTip="" Text='<%# Eval("Id_ENR") %>' navigateurl='<%# String.Format("WFAsignarENR.aspx?CodigoPaciente={0}&CodigoLocal={1}&CodigoProyecto={2}&CodigoUsuario={3}", Eval("CodigoPaciente"), Eval("CodigoLocal"), Eval("CodigoProyecto"),numUsuario) %>'> 
                                                    </asp:HyperLink>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="Header2" HorizontalAlign="Center" /><ItemStyle CssClass="Item2"/>
                                            </asp:TemplateField>

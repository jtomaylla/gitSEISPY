<%@ Page Title="Asignar ID Enrolamiento" Language="C#" AutoEventWireup="true" CodeBehind="WFAsignarID_ENR.aspx.cs" Inherits="WSProyectos.Consejeria.WFAsignarID_ENR" %>
				...
				<tr>
					<td vAlign="top" bgColor="#ffffff">
						<table id="Table4" cellspacing="0" cellpadding="0" align="center" border="0" width="250px">
							...
							<!--2-->
							<tr>
								<td Class="TitulitoLog" align="center">Asignar ID Enrolamiento</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
                                    <asp:Label ID="lblLocal0" runat="server" CssClass="TitulitosSub" 
                                        Text="ID-Enrolamiento:"></asp:Label>
                                </td>
							</tr>
							<tr>
								<td>
                                    <asp:TextBox ID="txtIdENR" runat="server" CssClass="textbox1" Width="200px"></asp:TextBox>
                                </td>
							</tr>
							<tr>
								<td></td>

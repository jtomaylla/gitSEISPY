<%@ Page Title="Lista de Códigos de Tamizaje" Language="C#" AutoEventWireup="true" CodeBehind="WFListaCodTAM.aspx.cs" Inherits="WSProyectos.Administracion.WFListaCodTAM" MasterPageFile="~/Site.Master"%>
                ...
                <td valign="top" align="left">
                  <asp:UpdatePanel ID="updUsuario" runat="server" UpdateMode="Conditional">
                    ...
                    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
                        <table>
                           <tr>
                            <td colspan="4"><asp:Label ID="Label1" runat="server" CssClass="Titulitos" Text="Lista de Códigos de Tamizaje"></asp:Label></td>
                        </tr>
                            <tr>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Label ID="lblRed1" runat="server" CssClass="TitulitosSub" Text="Cod.TAM:"></asp:Label>
                                </td>
                                <td>
                        ...
                        <tr>
                           <td colspan="4">
                                    <asp:LinkButton ID="btnNuevo" runat="server" onclick="btnNuevo_Click">Generar ID.TAM</asp:LinkButton>
                                    &nbsp;&nbsp;
                                    <asp:LinkButton ID="btnAgregar" runat="server" onclick="btnAgregar_Click">Crear ID.TAM</asp:LinkButton>
                            </td>
                        </tr>
                            <tr>
                                ...
                                <td colspan="4">
                                            ...
                                            <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False" DataKeyNames="CodigoProyecto"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Codigo" Visible="False">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCodigoTAM" runat="server" Text='<%# Bind("CodigoTAM") %>' ></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="CodigoTAM" HeaderText="Item" SortExpression="CodigoTAM">
                                                    ...
                                                    <asp:TemplateField HeaderText="Cod.TAM"  ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="hypTAM"  runat="server" ToolTip="" Text='<%# Eval("Numero") %>' navigateurl='<%# String.Format("WFCodTamEdit.aspx?vCodigoTAM={0}&vCodigoLocal={1}&vCodigoProyecto={2}&vCodigoUsuario={3}", Eval("CodigoTAM"), Eval("CodigoLocal"), Eval("CodigoProyecto"),numUsuario) %>'> 
                                                            </asp:HyperLink>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="" ShowHeader="False">
                                                        ...
                                                        <asp:LinkButton ID="imbLimpiar" SkinID="link_grilla" runat="server" AlternateText="Limpiar" CausesValidation="False"
                                                                CommandArgument='<%# Eval("CodigoTAM") %>' CommandName="Limpiar" ToolTip="Limpiar" Text="Limpiar"></asp:LinkButton>
                                                        </ItemTemplate>

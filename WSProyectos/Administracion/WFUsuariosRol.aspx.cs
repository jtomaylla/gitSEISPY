...
{
    public partial class WFUsuariosRol : System.Web.UI.Page
    {
        ...
        {
            dtLista = objCBUsuario.GetListarRolesxUser(int.Parse(Session["CodigoUsuarioR"].ToString()));
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            for (int I = 0; I < gvListado.Rows.Count; I++)
            {
                ...
                Label strCodigoRol = ((Label)gvListado.Rows[I].FindControl("lblcodigorol"));
                ...
                Num_Rpta = objCBUsuario.InsertarRolesxUser(int.Parse(Session["CodigoUsuarioR"].ToString()), int.Parse(strCodigoRol.Text), vEstado);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFCodTamEdit.aspx.cs" Inherits="WSProyectos.Administracion.WFCodTamEdit" %>
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="Label1" runat="server" CssClass="Titulitos" 
                                        Text="Editar Código de Tamizaje"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>

<%@ Page Title="Asignar Roles por Usuario" Language="C#" AutoEventWireup="true" CodeBehind="WFUsuariosRol.aspx.cs" Inherits="WSProyectos.Administracion.WFUsuariosRol" MasterPageFile="~/Site.Master"%>
                ...
                <td valign="top" align="left">
                  <asp:UpdatePanel ID="updUsuario" runat="server" UpdateMode="Conditional">
                    ...
                    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
                        <table>
                           <tr>
                            <td colspan="3"><asp:Label ID="Label1" runat="server" CssClass="Titulitos" Text="Asignar Roles por Usuario"></asp:Label></td>
                        </tr>
                            <tr>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                            ...
                                            <asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False" DataKeyNames="CodigoRol"
                                                CssClass="Grilla2" Width="400px" BorderStyle="None" BorderWidth="1px" 
                                                onrowdatabound="gvListado_RowDataBound">
                                                <EmptyDataTemplate>
                                                    <asp:Label ID="lblVacio" runat="server" Text="No se encontró Roles"
                                                ...
                                                <Columns>
                                                        <asp:TemplateField HeaderText="Código">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblcodigorol" runat="server" Text='<%# Bind("CodigoRol") %>'></asp:Label>

<%@ Page Title="Generar Código de Tamizaje" Language="C#" AutoEventWireup="true" CodeBehind="WFGenerarCodTAM.aspx.cs" Inherits="WSProyectos.Administracion.WFGenerarCodTAM" MasterPageFile="~/Site.Master"%>
                ...
                <td valign="top" align="left">
                  <asp:UpdatePanel ID="updUsuario" runat="server" UpdateMode="Conditional">
                    ...
                    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Left">
                        <table>
                           <tr>
                            <td colspan="3"><asp:Label ID="Label1" runat="server" CssClass="Titulitos" Text="Generar Código de Tamizaje"></asp:Label></td>
                        </tr>
                            <tr>
                                <td>
                                    &nbsp;</td>
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:GridView ID="gvListado" runat="server" AllowPaging="True" 
                                        ...
                                        CssClass="Grilla2" DataKeyNames="CodigoProyecto" GridLines="Vertical" 
                                        onpageindexchanging="gvListado_PageIndexChanging" Width="400px" 
                                        PageSize="30">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="numero" HeaderText="Código TAM" SortExpression="CodigoTAM">

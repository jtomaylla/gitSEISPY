<%@ Page Title="Editar Proyectos" Language="C#" AutoEventWireup="true" CodeBehind="WFProyectosEdit.aspx.cs" Inherits="WSProyectos.Administracion.WFProyectosEdit" MasterPageFile="~/Site.Master"%>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
       ...
       <asp:Panel ID="Panel1" runat="server" Width="700px">
            <table style="width: 700px">
            <tr>
                <td colspan="2"><asp:Label ID="Label1" runat="server" CssClass="Titulitos" Text="Editar Proyectos"></asp:Label>
</td></tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <asp:LinkButton ID="btnAceptar" runat="server" Text="Aceptar" 
                            onclick="btnAceptar_Click">Editar</asp:LinkButton>&nbsp; &nbsp;
                    </td>
                </tr>
            </table>

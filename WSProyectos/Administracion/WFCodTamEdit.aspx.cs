...
{
    public partial class WFCodTamEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Session["vCodigoTAM"] = Request["vCodigoTAM"].ToString();
        ...
        {
            int Resultado;
            Resultado = objCBProyecto.EditCodTAM(int.Parse(Session["vCodigoLocal"].ToString()),int.Parse(Session["vCodigoProyecto"].ToString()),int.Parse(Session["vCodigoTAM"].ToString()),txtNumeros.Text);

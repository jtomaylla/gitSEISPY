<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFCodEnrNew.aspx.cs" Inherits="WSProyectos.Administracion.WFCodEnrNew" %>
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:Label ID="Label1" runat="server" CssClass="Titulitos" 
                                        Text="Registrar Código de Enrolamiento"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>

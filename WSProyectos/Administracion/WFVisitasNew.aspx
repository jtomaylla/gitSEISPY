<%@ Page Title="Registro de Visitas" Language="C#" AutoEventWireup="true" CodeBehind="WFVisitasNew.aspx.cs" Inherits="WSProyectos.Administracion.WFVisitasNew" MasterPageFile="~/Site.Master"%>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div>
       ...
       <asp:Panel ID="Panel1" runat="server" Width="700px">
            ...
            <tr>
                <td colspan="2"><asp:Label ID="Label1" runat="server" CssClass="Titulitos" Text="Registro de Visitas"></asp:Label>
</td></tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvNombres" runat="server" 
                            ControlToValidate="txtNombre" ErrorMessage="Ingresar nombre" ForeColor="Red" ValidationGroup="Visita">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td style="width: 145px;">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvNombres0" runat="server" 
                            ControlToValidate="txtDescripcion" ErrorMessage="Ingresar descripción" 
                            ForeColor="Red" ValidationGroup="Visita">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td style="width: 145px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlGrupoAncla" runat="server" CssClass="textbox1" 
                            AutoPostBack="True" onselectedindexchanged="ddlGrupoAncla_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <asp:LinkButton ID="btnAceptar" runat="server" Text="Aceptar" 
                            onclick="btnAceptar_Click" ValidationGroup="Visita">Aceptar</asp:LinkButton>&nbsp; &nbsp;
                    </td>
                </tr>
            </table>
